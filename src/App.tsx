...
import { RunningSplitWidget } from './components/RunningSplitWidget';
...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-slate-50 font-sans">
      ...
      <div className="flex-1 w-full max-w-5xl mx-auto flex flex-col md:flex-row gap-6 p-4 mb-24 items-start">
        ...
        {receipt && (
          <aside className="w-full md:w-[320px] shrink-0 md:sticky md:top-24 fade-in animate">
            <RunningSplitWidget />
          </aside>
        )}
      </div>
